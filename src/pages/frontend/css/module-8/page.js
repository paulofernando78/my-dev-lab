...
import { sections } from "./module-8-data.js";
...
class CSSModuleEight extends HTMLElement {
  constructor() {
    super();
...
customElements.define("wc-frontend-css-module-8", CSSModuleEight);
export default CSSModuleEight;
