...
import { sections } from "./module-7-data.js";
...
class CSSModuleSeven extends HTMLElement {
  constructor() {
    super();
...
customElements.define("wc-frontend-css-module-7", CSSModuleSeven);
export default CSSModuleSeven;
