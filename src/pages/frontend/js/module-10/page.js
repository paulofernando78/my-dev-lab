...
// Sections
import { sections } from "./module-10-data.js";
...
class JSModuleTen extends HTMLElement {
  constructor() {
    super();
...
customElements.define("wc-frontend-js-module-10", JSModuleTen);
export default JSModuleTen;
