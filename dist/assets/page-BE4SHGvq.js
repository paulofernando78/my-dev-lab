import{s as e}from"./styles-DqAceQQB.js";import"./PageHeader-CvP__jNJ.js";import{r as s,s as a}from"./renderSection-DMH7LDba.js";import"./CardIcon-DXecrH-W.js";import"./SubSection-DcD0hYDi.js";import"./Wrapper-CztuctmA.js";import"./Image-BIJaaz-z.js";import"./CardCode-B2gB2WjZ.js";import"./Code-CJxCtOLx.js";import"./Demo-ChAFW9Ct.js";import"./Links-BGN6UMut.js";import"./LessonNav-DJR07540.js";import"./index-BlILq7lZ.js";const l={sectionId:"forms",sectionLabel:"Forms",sectionAriaLabel:"Forms",description:`
...
`,subSections:[{subSectionId:"form-structure",subSectionLabel:"Form Structure",subSectionAriaLabel:"Form Structure",description:`
...
<form action="/signup" method="post">
  ...
  <button type="submit">Submit</button>
                ...
                `}]},{subSectionId:"form-accessibility",subSectionLabel:"Labels & Submission",subSectionAriaLabel:"Labels and Submission",description:`
...
<form action="/contact" method="post">
  ...
  <button type="submit">Send</button>
                ...
                `}]}]},n={sectionId:"input-types",sectionLabel:"Input Types",sectionAriaLabel:"Input Types",description:`
...
`,subSections:[{subSectionId:"text",subSectionLabel:"text",subSectionAriaLabel:"text",description:`
...
<input type="text">
            ...
            `},{subSectionId:"email",subSectionLabel:"email",subSectionAriaLabel:"email",description:`
...
<input type="email" placeholder="joedoe@email.com">
            ...
            `},{subSectionId:"password",subSectionLabel:"password",subSectionAriaLabel:"password",description:`
...
<input type="password" placeholder="1234...">
            ...
            `},{subSectionId:"number",subSectionLabel:"number",subSectionAriaLabel:"number",description:`
...
<input type="number" placeholder="Numbers only">
            ...
            `},{subSectionId:"radio",subSectionLabel:"radio",subSectionAriaLabel:"radio",description:`
...
<div class="flex-align-center">
  ...
  <label for="opt2">Option 2</label>
            ...
            `},{subSectionId:"checkbox",subSectionLabel:"checkbox",subSectionAriaLabel:"checkbox",description:`
...
<div class="flex-align-center">
  ...
  <label for="terms">I agree to the terms</label>
            ...
            `},{subSectionId:"option",subSectionLabel:"option",subSectionAriaLabel:"option",description:`
...
<label for="color">Color</label>
            ...
            `},{subSectionId:"file",subSectionLabel:"file",subSectionAriaLabel:"file",description:`
...
<input type="file">
            ...
            `},{subSectionId:"textarea",subSectionLabel:"textarea",subSectionAriaLabel:"textarea",description:`
...
<textarea></textarea>
            ...
            `,sandbox:[{html:!0}]}]},i={sectionId:"resources",sectionLabel:"Resources",sectionAriaLabel:"Resources",description:`
...
`,links:[{href:"/",label:"..."}]},o=[l,n,i],r=`
  label {
    display: block;
    margin-bottom: 0.5rem
  }
`;class c extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}disconnectedCallback(){}render(){this.shadowRoot.innerHTML=`
      <style>
        ${e}
        ${r}
      </style>
      ...
      <input type="text">
      `}}customElements.define("wc-html-module-6-text",c);const d=`
  label {
    display: block;
    margin-bottom: 0.5rem
  }
`;class m extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
      ...
      <label>Email:</label>
      <input type="email" placeholder="joedoe@email.com">
      `}}customElements.define("wc-html-module-6-email",m);const u=`
  label {
    display: block;
    margin-bottom: 0.5rem
  }
`;class p extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
      <style>
        ${e}
        ${u}
      </style>
      ...
      <input type="Password" placeholder="1234...">
      `}}customElements.define("wc-html-module-6-password",p);class b extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
      <style>
        ${e}
      </style>
      <input type="number" placeholder="Numbers only">
      `}}customElements.define("wc-html-module-6-number",b);class h extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
      <style>
        ${e}
      </style>
      <div class="flex-align-center">
      ...
      `}}customElements.define("wc-html-module-6-radio",h);class w extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
      <style>
        ${e}
      </style>
      <div class="flex-align-center">
...
`;class y extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
    ...
    `}}customElements.define("wc-html-module-6-file",y);const L=`
  label {
    display: block;
    margin-bottom: 0.5rem
  }
`;class x extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
    ...
    `}}customElements.define("wc-html-module-6-textarea",x);const v=`
...
`;class S extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
      ...
      <div class="line-break">${s(o)}</div>
      <wc-lesson-nav></wc-lesson-nav>
    `,a(this.shadowRoot,o)}}customElements.define("wc-frontend-html-module-6",S);export{S as default};
